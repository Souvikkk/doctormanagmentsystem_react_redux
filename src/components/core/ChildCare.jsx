...
import { fetchAllChildCare } from '../../Redux/ChildCareSlice'
import { GridLoader } from 'react-spinners'

const ChildCare = () => {
  const {all_child_care_data,status} = useSelector((state)=>state?.childcare)
                ...
                <>
                  <div className="col-lg-3 col-md-6 col-sm-6">
                    <div className="team-block mb-5 mb-lg-0">
                      <img
                        src={`${process.env.PUBLIC_URL}/images/child/childdoc.jpeg`}
                        alt=""
